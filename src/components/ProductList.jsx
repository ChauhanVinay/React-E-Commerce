...
import { Link } from "react-router-dom"; // 1. Ensure Link is imported

const productsArr = [
  // IMPORTANT: Assign unique IDs to your products so the URL knows which one to load
  ...
  return (
    <Container className="py-5" style={{ maxWidth: '900px' }}>
      ...
      <Row className="g-5 justify-content-center">
        {productsArr.map((product) => ( // Use unique ID as key
          <Col key={product.id} xs={12} md={6} className="d-flex justify-content-center mb-4">
            <div className="text-center" style={{ width: '250px' }}>
              ...
              <Link to={`/product/${product.id}`}>
                <img 
                  ...
                  style={{ height: '250px', width: '250px', objectFit: 'cover', cursor: 'pointer' }} 
                />
              </Link>
